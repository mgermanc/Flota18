...
class TestAccountFlota(AccountTestInvoicingCommon):

    @freeze_time('2021-09-15')
    def test_transfer_wizard_impresora_info_propagation(self):
        ...
        bill.invoice_line_ids.write({'impresora_id': car_1.id})
        bill.action_post()
        ...
        self.assertEqual(transfer_moves.line_ids.filtered(lambda l: l.account_id == expense_account).impresora_id, car_1, "Impresora info is missing")
